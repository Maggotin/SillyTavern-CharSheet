...
$nav-items: my-content, builder, characters, items, spells, monsters, compendium, articles, forums, marketplace;
$base-classes: bard, cleric, druid, paladin, ranger, sorcerer, warlock, wizard, barbarian, fighter, monk, rogue;
$base-races: dwarf, elf, halfling, human, dragonborn, gnome, halfelf, halforc, tiefling;
...
$ability-scores: strength, dexterity, constitution, charisma, wisdom, intelligence;
$conditions: blinded, charmed, deafened, exhaustion, exhausted, frightened, grappled, incapacitated, invisible, paralyzed, petrified, poisoned, prone, restrained, stunned, unconscious;
$monster-types: aberration, beast, celestial, construct, dragon, elemental, fey, fiend, giant, humanoid, monstrosity, ooze, plant, undead;
$item-types: armor, artifact, potion, ring, rod, scroll, staff, wand, weapon, wondrousitem;
...
$font--scala-sans-sc-offc: "Scala Sans Sc Offc", $font-family;
$font--mrs-eaves-small-caps: MrsEavesSmallCaps, $font-family;
$font-color: $black;

$tm-quaternaryFontColor: #fff;

$imageURL-local: "https://www.dndbeyond.com/Content/Skins/Waterdeep/images" !default;
$site-width: 1200px;
$common-site-bg: #f9f9f9 url("#{$imageURL-local}/background_texture.png") repeat;
