export class CharacterSheetManager {
    ...
    async init() {
        ...
        // Make draggable first
        $(this.dom).draggable({
            handle: '.drag-grabber',
            containment: 'window'
        });

        // Then initialize resizable
        $(this.dom).resizable({
            handles: {
                'n': '.ui-resizable-n',
                'e': '.ui-resizable-e',
            ...
            minWidth: 300,
            classes: {
                "ui-resizable-n": "ui-resizable-handle",
                "ui-resizable-e": "ui-resizable-handle",
                "ui-resizable-s": "ui-resizable-handle",
                "ui-resizable-w": "ui-resizable-handle",
                "ui-resizable-ne": "ui-resizable-handle",
                "ui-resizable-se": "ui-resizable-handle",
                "ui-resizable-sw": "ui-resizable-handle",
                "ui-resizable-nw": "ui-resizable-handle"
            }
        });
