export class CharacterSheetManager {
    ...
    initializeSheetLogic() {
        ...
        const tabPanes = {
            'coretab': document.getElementById('tab-core'),
            'inventorytab': document.getElementById('tab-inventory'),
            'spellstab': document.getElementById('tab-spells'),
        };
        ...
        const paneId = tabs.getAttribute('data-tab');
        if (tabPanes[paneId]) {
