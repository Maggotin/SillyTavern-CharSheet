export class CharacterSheetManager {
    ...
    async init() {
        ...
        console.debug('Sheet initialization complete', { 
            dom: this.dom, 
    ...
    show() {
        if (!this.dom) {
            console.warn('Cannot show sheet - not initialized');
            return;
        }
        console.debug('Showing character sheet');
    ...
    hide() {
        if (!this.dom) {
            console.warn('Cannot hide sheet - not initialized');
            return;
        }
        console.debug('Hiding character sheet');
        this.dom.style.display = 'none';
        this.isActive = false;
    }

    toggle() {
        console.debug('Toggle called, isActive:', this.isActive);
        if (this.isActive) {
            this.hide();
        } else {
            this.show();
