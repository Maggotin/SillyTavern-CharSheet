...
eventSource.on(event_types.CHAT_CHANGED, () => { if (context.extensionSettings[settingsKey].enabled) { initializeCharacterSheet(); // Example: show a small toast or log toastr.info('Character Sheet loaded', EXTENSION_NAME); } });
