...
eventSource.on(event_types.EXTENSION_UNLOADED, (extName) => { if (extName === EXTENSION_NAME) { 
    // Hide or clean up the UI characterSheetManager?.hide(); const drawer = document.getElementById(${settingsKey}-drawer); if (drawer) { drawer.style.display = 'none'; } } }); })();